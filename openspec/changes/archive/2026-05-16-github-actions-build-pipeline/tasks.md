...
- [x] 3.1 Push the workflow file on a feature branch and open a pull request against `main`; confirm the workflow run starts automatically
- [x] 3.2 Verify the run completes successfully with all steps green
...
- [x] 3.4 Merge the pull request once the workflow is confirmed working
